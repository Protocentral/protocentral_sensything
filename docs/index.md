...
Follow the link above on how to set up the Arduino IDE [Setting up Arduino for use with Sensything] (http://sensything.protocentral.com/sensything-with-arduino.html) for Sensything.
