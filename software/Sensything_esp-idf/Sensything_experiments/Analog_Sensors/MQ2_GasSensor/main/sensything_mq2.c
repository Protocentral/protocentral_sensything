...
void sensything_ads1220read_channel2(void){
  ...
  sensor_volt= channel2 /1024*5.0;                              // Measuring mq2 gas sensor voltage
  printf("Sensor_ volt: %f \n",sensor_volt);
  RS_gas = (5.0-sensor_volt)/sensor_volt;                  // Calculating gas concentration
  printf("Gas Concentration : %f \n",RS_gas );
...
void sensything_ads1220read_channel3(void){
  ...
  sensor_volt= channel3 /1024*5.0;                              // Measuring mq2 gas sensor voltage
  printf("Sensor_ volt: %f \n",sensor_volt);
  RS_gas = (5.0-sensor_volt)/sensor_volt;                  // Calculating gas concentration
  printf("Gas Concentration : %f \n",RS_gas );
...
void sensything_ads1220read_channel4(void){
  ...
  sensor_volt= channel4 /1024*5.0;                              // Measuring mq2 gas sensor voltage
  printf("Sensor_ volt: %f \n",sensor_volt);
  RS_gas = (5.0-sensor_volt)/sensor_volt;                  // Calculating gas concentration
  printf("Gas Concentration : %f \n",RS_gas );
